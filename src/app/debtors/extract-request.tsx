...
import { DebtorAppExtractRequestScreen } from '@/components/debtor-registry/debtor-app-extract-request-screen';
...
export default function DebtorAppExtractRequestRoute() {
  ...
  return <DebtorAppExtractRequestScreen />;
}

        ...
        <ScrollView style={s.contentScroll} contentContainerStyle={s.contentWrap}>
          <View style={s.titleRow}>
            ...
            <View style={s.notifWrap}>
              <Text style={s.notifText}>{DebtorRegistryCopy.notifications}</Text>
            ...
            <View style={s.listWrap}>
              ...
              {!query.isLoading && items.length > 0 && (
                <View style={s.pagination}>
                  ...
                  >
                    <Text style={s.pageButtonText}>{DebtorRegistryCopy.previousPage}</Text>
                  </Pressable>
                  ...
                  >
                    <Text style={s.pageButtonText}>{DebtorRegistryCopy.nextPage}</Text>
                  </Pressable>
                </View>
              )}
            </View>

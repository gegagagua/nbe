export const kaAuth = {
  ...
  deviceTrust: {
    ...
    requiresBiometrics:
      "ჯერ დააყენეთ ეკრანის დაბლოკვა (Face ID / თითის ანაბეჭდი ან პაროლი) მოწყობილობის პარამეტრებში — მის გარეშე გასანდოება ვერ ჩაირთვება.",
    ...
    forgetServerFailed:
      "მოწყობილობა ამ აპიდან წაიშალა, თუმცა სერვერთან სინქრონიზაცია ვერ მოხერხდა.",
    errorCancelled: "მოქმედება გაუქმდა.",
    errorFailed: "მოწყობილობის გასანდოება ვერ მოხერხდა. სცადეთ თავიდან.",
    errorAlreadyRegistered: "ეს მოწყობილობა უკვე გასანდოებულია.",
    errorNoCredential:

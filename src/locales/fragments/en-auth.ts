export const enAuth = {
  login: {
    ...
    registerStatusFailed: "Validation could not be completed. Please try again",
  ...
  passwordHistory: {
    buttonLabel: "Password history",
    modalTitle: "Password History",
    tableHeaderDate: "Date",
    tableHeaderTime: "Time",
    emptyMessage: "No password change history found.",
    closeButton: "Close",
    lastChange: "Password change",
  },
  loginHistory: {
    buttonLabel: "Login history",
    modalTitle: "Application Login History",

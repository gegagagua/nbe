...
export const HomeDashboardLayoutConst = {
  ...
  notificationBadgeSmallMinWidth: 18,
  notificationBadgeSmallHeight: 18,
  notificationBadgeSmallRadius: 9,
  notificationBadgeSmallPadH: Spacing.one,
  notificationBadgeSmallLineHeight: 14,
  navCardIconSize: 22,
  tabInnerRadius: 12,

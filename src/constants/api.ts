// ── User Management ──────────────────────────────────────────────────────────
export const UmApiBase = 'http://nbe-eps-um-api.staging.cloud.gov.ge';

// ── EPS-API (cases) ───────────────────────────────────────────────────────────
export const EpsApiBase = 'http://nbe-eps-api.staging.cloud.gov.ge';

// ── EPS-MONEY-API ─────────────────────────────────────────────────────────────
export const EpsMoneyApiBase = 'http://nbe-eps-money-api.staging.cloud.gov.ge';

// ── EPS-INSTALLMENT-API ───────────────────────────────────────────────────────
export const EpsInstallmentApiBase = 'http://nbe-eps-installment-api.staging.cloud.gov.ge';

// ── EPS-EAUCTION-API ──────────────────────────────────────────────────────────
export const EpsEauctionApiBase = 'http://nbe-eps-eauction-api.staging.cloud.gov.ge';

// ── EPS-MIA-API ───────────────────────────────────────────────────────────────
export const EpsMiaApiBase = 'http://nbe-eps-mia-api.staging.cloud.gov.ge';

// ── EPS-SSA-API ───────────────────────────────────────────────────────────────
export const EpsSsaApiBase = 'http://nbe-eps-ssa-api.staging.cloud.gov.ge';

// ── EPS-NAPR-API ──────────────────────────────────────────────────────────────
export const EpsNaprApiBase = 'http://nbe-eps-napr-api.staging.cloud.gov.ge';
...
export const ApiPaths = {
  ...
  // EPS-MONEY-API
  debtorMoney: (appId: number | string) => `/portal/v1/reg-money/debtor/app/${appId}`,
  creditorMoney: (appId: number | string) => `/portal/v1/reg-money/creditor/app/${appId}`,
